      ...
      <div className="shell">
        ...
        <div className="catalog-layout">
          ...
          <div>
            ...
            {products.length ? (
              <div className="grid">{products.map((product, index) => <ProductCard key={product.id} product={product} searchQuery={params.q} position={(currentPage - 1) * CATALOG_PAGE_SIZE + index + 1} priority={index < 16} />)}</div>
            ) : (
